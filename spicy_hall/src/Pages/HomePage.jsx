...
const HomePage = () => {
  ...
  return (
    <div style={{ backgroundColor: "black", color: "white" }}>
            ...
            <div>
              ...
              <div className="variety-offer">
                <p>
                  ...
                  world great authentic taste and quality. We are No.1
                  restuarant in the world. Explore more in our website
                </p>
              </div>
      ...
      {/* Container 3 */}
      <Parallax strength={-400} bgImage={bg2}>
        <div className="story-main-container">
          <div className="story-cont1">
            <div className="story-div1">
              ...
              <p>
                A strong restaurant identity, hiring and retaining your staff
                and building a supportive environment, familiarizing yourself
                with profit and loss statements, creating a profitable menu (and
      ...
      {/* Container 4 */}
      <Parallax strength={-400} bgImage={bg3}>
          ...
          <div className="bg-flex">
            ...
            <div className="special-dish">
              ...
              <div>
                <p>ROASTED BEEF</p>
                <p>
                  There’s a reason beef has a regular place in our weekly meal
                  plans (several reasons, actually!). Beef is an incredibly
                  versatile and affordable option (depending on how you shop)
                  that can be cooked into many different types of dinners. Make
                  the most of beef cuts in various recipes. Use mince for
